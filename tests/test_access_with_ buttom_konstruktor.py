...
from Lokators import PERSONAL_ACCOUNT_BUTTON, EMAIL_BUTTON, ENTER_BUTTON_PERSONAL_ACCOUNT, KONSTRUKTOR_BUTTON


def test_access_to_main_page(driver):
    ...
    try:
        ...
        login_button = WebDriverWait(driver, 10).until(
            EC.element_to_be_clickable((By.XPATH, KONSTRUKTOR_BUTTON))
        )
